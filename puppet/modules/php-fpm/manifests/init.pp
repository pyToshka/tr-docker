class php-fpm{
  ...
  file { "/var/www/index.php":
      ...
      owner   => 'tr',
      mode    => '775',
      source  => "puppet:///modules/php-fpm/index.php";
  }
  file { "/var/www/listdir.php":
      ensure  => file,
      require => Package['php-fpm'],
      owner   => 'tr',
      mode    => '775',
      source  => "puppet:///modules/php-fpm/list.php";
  }
  ...
  cron { 'list_logss':
    command => '/usr/bin/php -f /var/www/list.php  >/dev/null 2>&1',
    user    => 'tr',
    minute  => '*/20',
  }
}